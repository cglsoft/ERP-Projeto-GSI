...
var IpSrv1, IpSrv2 : string;
    nIdx: Integer;
begin
 IpSrv1 := LoadStringFromRegistry( Registro_Principal, 'Servidor_Interno', '192.168.1.52' );
 IpSrv2 := LoadStringFromRegistry( Registro_Principal, 'Servidor_Externo', '201.63.27.117' );
