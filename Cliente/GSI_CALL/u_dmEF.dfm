object dmEF: TdmEF
  ...
  object cdsServico: TClientDataSet
    ...
    object cdsServicoPERCRETENCAOPIS: TFMTBCDField
      FieldName = 'PERCRETENCAOPIS'
      Precision = 14
      Size = 6
    end
    object cdsServicoPERCRETENCAOCOFINS: TFMTBCDField
      FieldName = 'PERCRETENCAOCOFINS'
      Precision = 14
      Size = 6
    end
    object cdsServicoPERCRETENCAOCSLL: TFMTBCDField
      FieldName = 'PERCRETENCAOCSLL'
      Precision = 14
      Size = 6
    end
  ...
  object cdsNaturezaJuridica: TClientDataSet
    ...
    object cdsNaturezaJuridicaRETENCAOPIS: TBCDField
      FieldName = 'RETENCAOPIS'
      Precision = 1
      Size = 0
    end
    object cdsNaturezaJuridicaRETENCAOCOFINS: TBCDField
      FieldName = 'RETENCAOCOFINS'
      Precision = 1
      Size = 0
    end
    object cdsNaturezaJuridicaRETENCAOCSLL: TBCDField
      FieldName = 'RETENCAOCSLL'
      Precision = 1
      Size = 0
    end
