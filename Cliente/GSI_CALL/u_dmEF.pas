...
type
  TdmEF = class(TDataModule)
    ...
    cdsNaturezaJuridicaRETENCAOPIS: TBCDField;
    cdsNaturezaJuridicaRETENCAOCOFINS: TBCDField;
    cdsNaturezaJuridicaRETENCAOCSLL: TBCDField;
    ...
    cdsServicoPERCRETENCAOPIS: TFMTBCDField;
    cdsServicoPERCRETENCAOCOFINS: TFMTBCDField;
    cdsServicoPERCRETENCAOCSLL: TFMTBCDField;
...
begin
 ...
 cdsProdutoCONTACTBRECEITA.Value := CtaCtb;

 if cdsProdutoSUBGRUPOID.Value = 8 then
    begin
     if cdsProdutoORIGEM.Value = 'N' then
        begin
         cdsProdutoCONTACTBATIVO.Value   := '11401001';
         cdsProdutoCONTACTBDESPESA.Value := '41101001';
        end;

     if cdsProdutoORIGEM.Value = 'I' then
        begin
         cdsProdutoCONTACTBATIVO.Value   := '11401001';
         cdsProdutoCONTACTBDESPESA.Value := '41101001';
        end;

     if cdsProdutoORIGEM.Value = 'B' then
        begin
         cdsProdutoCONTACTBATIVO.Value   := '11401001';
         cdsProdutoCONTACTBDESPESA.Value := '41101001';
        end;
    ...
    begin
     if cdsProdutoORIGEM.Value = 'N' then
        begin
         cdsProdutoCONTACTBATIVO.Value   := '11401002';
         cdsProdutoCONTACTBDESPESA.Value := '41101002';
        end;
...
begin
 ...
 iSQL    := 'SELECT ' +
            ...
            '  EF_NATUREZAJURIDICA.RETENCAOPIS,' +
            '  EF_NATUREZAJURIDICA.RETENCAOCOFINS,' +
            '  EF_NATUREZAJURIDICA.RETENCAOCSLL' +
            '  FROM' +
            '  EF_ENTIDADE,' +
 ...
 iSqlServ:= 'SELECT EMPRESAID, SERVICOID, PERCRETENCAOPIS, PERCRETENCAOCOFINS, PERCRETENCAOCSLL, ' +
            ' CALCULARPIS, CALCULARCOFINS ' +
            ' FROM EF_SERVICO ' +
            ' WHERE ' +
            ' EMPRESAID = ' + cdsPdsServicoEMPRESAID.AsString +
            ' AND SERVICOID = ' + cdsPdsServicoSERVICOID.AsString;
 ...
 try
  ...
  if cds.FieldByName('RETENCAOPIS').AsInteger = 1 then
     cdsPdsServicoVLRRETPIS.Value    := cdsPdsServicoVLRSERVICO.Value * ( cdsServ.FieldByName('PERCRETENCAOPIS').AsCurrency / 100 );

  if cds.FieldByName('RETENCAOCOFINS').AsInteger = 1 then
     cdsPdsServicoVLRRETCOFINS.Value := cdsPdsServicoVLRSERVICO.Value * ( cdsServ.FieldByName('PERCRETENCAOCOFINS').AsCurrency / 100 );

  if cds.FieldByName('RETENCAOCSLL').AsInteger = 1 then
     cdsPdsServicoVLRRETCSLL.Value   := cdsPdsServicoVLRSERVICO.Value * ( cdsServ.FieldByName('PERCRETENCAOCSLL').AsCurrency / 100 );
...
begin
 ...
 cdsServicoPERCRETENCAOPIS.AsFloat    := 0;
 cdsServicoPERCRETENCAOCOFINS.AsFloat := 0;
 cdsServicoPERCRETENCAOCSLL.AsFloat   := 0;
