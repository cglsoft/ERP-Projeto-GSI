...
type
  TfrmReconcileError = class(TForm)
    UpdateType: TLabel;
...
function HandleReconcileError(DataSet: TDataSet; UpdateKind: TUpdateKind;
  ReconcileError: EReconcileError): TReconcileAction;
var
  UpdateForm: TfrmReconcileError;
begin
  UpdateForm := TfrmReconcileError.CreateForm(DataSet, UpdateKind, ReconcileError);
  with UpdateForm do
  try
...
constructor TfrmReconcileError.CreateForm(DataSet: TDataSet;
...
procedure TfrmReconcileError.InitDataFields;
var
  I: Integer;
  FD: PFieldData;
  V: Variant;
...
procedure TfrmReconcileError.InitUpdateData(HasCurValues: Boolean);
var
  FColCount: Integer;
begin
  FColCount := 1;
...
procedure TfrmReconcileError.InitReconcileActions;
...
procedure TfrmReconcileError.DisplayFieldValues(Sender: TObject);
var
  I: Integer;
  CurRow: Integer;
...
procedure TfrmReconcileError.SetFieldValues(DataSet: TDataSet);
var
  I: Integer;
begin
  for I := 0 to FDataFields.Count - 1 do
...
procedure TfrmReconcileError.AdjustColumnWidths;
var
  NewWidth, I: integer;
begin
  with UpdateData do
...
procedure TfrmReconcileError.FormCreate(Sender: TObject);
begin
...
procedure TfrmReconcileError.FormDestroy(Sender: TObject);
var
  I: Integer;
begin
...
procedure TfrmReconcileError.UpdateDataSetEditText(Sender: TObject; ACol,
...
procedure TfrmReconcileError.UpdateDataSelectCell(Sender: TObject; Col,
