...
procedure TfrmRel0027.QRLabel2Print(sender: TObject; var Value: String);
begin
 Value := Value + frmPrecoTransferencia.wwdtpcktDtIni2.Text + ' a '+ frmPrecoTransferencia.wwdtpcktDtFim2.Text;
end;

procedure TfrmRel0027.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 Action := cafree;
 frmRel0027 := nil;
end;
