object frm0019: Tfrm0019
  ...
  object Panel23: TPanel
    ...
    object Label59: TLabel
      ...
      Width = 276
      Height = 24
      Caption = 'Registro Controle de Estoque'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -20
      Font.Name = 'MS Sans Serif'
  ...
  object GroupBox1: TGroupBox
    ...
    object wwdtpcktCtrlEstoqueIni: TwwDBDateTimePicker
      Left = 12
      Top = 38
      Width = 85
      Height = 21
    ...
    object wwdtpcktCtrlEstoqueFim: TwwDBDateTimePicker
      Left = 108
      Top = 36
      Width = 93
      Height = 21
    ...
    object rgrpMov: TRadioGroup
      Left = 204
      Top = 29
      Width = 161
      Height = 46
      Caption = 'Movimenta'#231#227'o de Terceiros'
      ItemIndex = 1
      Items.Strings = (
        'Todos'
        'Invent'#225'rio')
  ...
  object dsCtrlEstoque: TDataSource
    DataSet = cdsCtrlEstoque
    Left = 416
  end
  object cdsCtrlEstoque: TClientDataSet
    Aggregates = <>
    FieldDefs = <>
    IndexDefs = <>
    Params = <>
